        ...
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              placeholder="https://fb.com/sosamsony"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://twitter.com/sosamsony"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://instagram.com/sosamsony"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://github.com/sosamsony"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://t.me/sosamsony"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://linkedin.com/in/sosamsony"
            />
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://youtube.com/@sosamsony"
            />
          </div>
        </div>
        <div>
